...
export class Tooltip extends BaseComponent<TooltipPassThroughOptions> {
     ...
     * @group Props
     */
    tooltipPosition = input<'right' | 'left' | 'top' | 'bottom' | string>();
    /**
     ...
     * @group Props
     */
    showDelay = input<number, unknown>(undefined, { transform: numberAttribute });
    /**
     * Delay to hide the tooltip in milliseconds.
     * @group Props
     */
    hideDelay = input<number, unknown>(undefined, { transform: numberAttribute });
    /**
     ...
     * @group Props
     */
    positionTop = input<number, unknown>(undefined, { transform: numberAttribute });
    /**
     * Specifies the additional horizontal offset of the tooltip from its default position.
     * @group Props
     */
    positionLeft = input<number, unknown>(undefined, { transform: numberAttribute });
    /**
     ...
     * @group Props
     */
    // eslint-disable-next-line @angular-eslint/no-input-rename -- `tooltipDisabled` is published public API; renaming would break consumers.
    disabled = input(false, { alias: 'tooltipDisabled', transform: booleanAttribute });
    /**
    ...
    constructor() {
        ...
        effect(() => {
            ...
            this._tooltipOptions = { ...this._tooltipOptions, ...tooltipOptions };
            this.deactivate();
    ...
    getOption(option: string) {
        return this._tooltipOptions[option as keyof TooltipOptions];
    }
