...
export class ColorPicker extends BaseEditableHolder<ColorPickerPassThrough> implements AfterViewChecked {
     ...
     * @group Props
     */
    inline = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
     ...
     * @group Props
     */
    defaultColor = input<string | undefined>('ff0000');
    /**
...
@NgModule({
    imports: [ColorPicker, ColorPickerDirective, SharedModule],
    exports: [ColorPicker, ColorPickerDirective, SharedModule]
})
