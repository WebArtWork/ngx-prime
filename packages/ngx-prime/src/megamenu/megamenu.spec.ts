...
describe('MegaMenu', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should initialize with generated id', () => {
            ...
            expect(freshMegaMenu.resolvedId).toBeTruthy();
            expect(typeof freshMegaMenu.resolvedId).toBe('string');
            expect(freshMegaMenu.resolvedId).toMatch(/^pn_id_/);
        });
    ...
    describe('CSS Classes and Styling', () => {
        ...
        it('should have generated id on host element', () => {
            ...
            expect(hostElement.getAttribute('id')).toBe(freshMegaMenu.resolvedId);
        });
        ...
        it('should have generated id on host element', () => {
            ...
            expect(hostElement.getAttribute('id')).toBeTruthy();
            expect(hostElement.getAttribute('id')).toBe(megaMenuInstance.resolvedId);
        });
    });
