...
import { StepItemPassThrough, StepListPassThrough, StepPanelPassThrough, StepPanelsPassThrough, StepPassThrough, StepperPassThrough, StepperSeparatorPassThrough } from '@wawjs/ngx-prime/types/stepper';
...
@Component({
    selector: 'p-step',
    standalone: true,
    imports: [StepperSeparator, SharedModule, BindModule],
    template: `
...
@Component({
    ...
    standalone: true,
    imports: [StepperSeparator, SharedModule, BindModule, MotionModule],
    template: `
