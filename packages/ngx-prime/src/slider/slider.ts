...
import type { SliderChangeEvent, SliderSlideEndEvent } from 'ngx-prime/types/slider';
import { SliderPassThrough } from 'ngx-prime/types/slider';
...
export class Slider extends BaseEditableHolder<SliderPassThrough> {
     ...
     * @group Props
     */
    animate = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
     ...
     * @group Props
     */
    range = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
