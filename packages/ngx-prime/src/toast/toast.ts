...
import { booleanAttribute, ChangeDetectionStrategy, Component, computed, effect, inject, InjectionToken, input, NgModule, NgZone, numberAttribute, output, signal, TemplateRef, ViewEncapsulation, contentChild, contentChildren } from '@angular/core';
import { MotionEvent, MotionOptions } from '@wawjs/css-prime-motion';
import { isEmpty, setAttribute, uuid } from '@wawjs/css-prime-utils';
import { MessageService, PrimeTemplate, SharedModule, ToastMessageOptions } from '@wawjs/ngx-prime/api';
import { BaseComponent, PARENT_INSTANCE } from '@wawjs/ngx-prime/basecomponent';
import { Bind } from '@wawjs/ngx-prime/bind';
import { CheckIcon, ExclamationTriangleIcon, InfoCircleIcon, TimesCircleIcon, TimesIcon } from '@wawjs/ngx-prime/icons';
import { MotionModule } from '@wawjs/ngx-prime/motion';
import { ToastCloseEvent, ToastHeadlessTemplateContext, ToastItemCloseEvent, ToastMessageTemplateContext, ToastPassThrough, ToastPositionType } from '@wawjs/ngx-prime/types/toast';
...
export class ToastItem extends BaseComponent<ToastPassThrough> {
    ...
    index = input<number | undefined, unknown>(undefined, { transform: numberAttribute });
...
export class Toast extends BaseComponent<ToastPassThrough> {
     ...
     */
    showTransformOptions = input('translateY(100%)');
    /**
     * Transform options of the hide animation.
     * @group Props
     * @deprecated since v21.0.0. Use `motionOptions` instead.
     */
    hideTransformOptions = input('translateY(-100%)');
    /**
     ...
     * @deprecated since v21.0.0. Use `motionOptions` instead.
     */
    hideTransitionOptions = input('250ms ease-in');
    /**
     * The motion options.
     * @group Props
     */
     ...
     * @group Props
     */
    breakpoints = input<{ [key: string]: any }>();
    /**
