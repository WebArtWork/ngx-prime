...
import { ChevronUpIcon } from 'ngx-prime/icons';
import { MotionDirective } from 'ngx-prime/motion';
import { ScrollTopIconTemplateContext, ScrollTopPassThrough } from 'ngx-prime/types/scrolltop';
