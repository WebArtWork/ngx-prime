...
@Component({
    ...
    template: `<p-scrolltop [threshold]="threshold" [target]="target" [behavior]="behavior" [icon]="icon"></p-scrolltop>`,
    ...
    template: `
        <p-scrolltop [threshold]="50">
            <ng-template #icon let-styleClass="styleClass">
                <span class="custom-icon" [ngClass]="styleClass">â†‘</span>
            </ng-template>
        </p-scrolltop>
    `,
    imports: [ScrollTopModule]
...
describe('ScrollTop', () => {
    ...
    describe('Icon and Templates', () => {
        ...
        it('should render icon template', () => {
            ...
            expect(customIcon.nativeElement.textContent).toBe('â†‘');
        });
    ...
    describe('Lifecycle Hooks', () => {
        ...
        it('should clean up on destroy for parent target', () => {
            (scrollTop as any).target = () => 'parent';
