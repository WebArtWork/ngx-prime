...
import { FileUploadDirective } from './nativefileupload';
...
export class FileUpload extends BaseComponent<FileUploadPassThrough> implements BlockableUI {
     ...
     * @group Props
     */
    auto = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
     * Cross-site Access-Control requests should be made using credentials such as cookies, authorization headers or TLS client certificates.
     * @group Props
     */
    withCredentials = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
     ...
     * @group Props
     */
    fileLimit = input<number | undefined, unknown>(undefined, { transform: (value: unknown) => numberAttribute(value, undefined) });
    /**
...
@NgModule({
    imports: [FileUpload, FileUploadDirective, SharedModule],
    exports: [FileUpload, FileUploadDirective, SharedModule]
})
