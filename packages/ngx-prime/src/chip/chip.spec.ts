...
class TestImageChipComponent {
    image = signal('/path/to/image.jpg');
...
describe('Chip', () => {
    ...
    describe('ChipProps', () => {
        ...
        it('should apply chipProps values', async () => {
            expect(chipComponent.resolvedLabel()).toBe('Props Chip');
            expect(chipComponent.resolvedIcon()).toBe('pi pi-star');
            expect(chipComponent.resolvedRemovable()).toBe(true);
            expect(chipComponent.resolvedStyleClass()).toBe('props-chip');
        });
        ...
        it('should update when chipProps changes', async () => {
            ...
            expect(chipComponent.resolvedIcon()).toBe('pi pi-home');
            expect(chipComponent.resolvedRemovable()).toBe(false);
            expect(chipComponent.resolvedStyleClass()).toBe('updated-props');
        });
