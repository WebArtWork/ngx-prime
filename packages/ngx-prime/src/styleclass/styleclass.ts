...
export class StyleClass implements OnDestroy {
     ...
     * @group Props
     */
    hideOnOutsideClick = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
     ...
     * @group Props
     */
    hideOnEscape = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
     * Whether to trigger leave animation when the target element resized.
     * @group Props
     */
    hideOnResize = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
