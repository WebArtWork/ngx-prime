...
@Component({
    ...
    `,
    imports: [Menu, TestTargetComponent, SharedModule]
})
...
describe('Menu', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should initialize with generated id', () => {
            ...
            expect(freshMenu.resolvedId).toBeTruthy();
            expect(typeof freshMenu.resolvedId).toBe('string');
            expect(freshMenu.resolvedId).toMatch(/^pn_id_/);
        });
    ...
    describe('CSS Classes and Styling', () => {
        ...
        it('should apply custom styles', () => {
            ...
            const styleValue = menuInstance.style();
            ...
            if (styleValue) {
                Object.keys(styleValue).forEach((key) => {
                    hostElement.style[key] = styleValue[key];
                });
            }
        ...
        it('should have generated id on container element', () => {
            ...
            expect(containerElement.nativeElement.getAttribute('id')).toBe(freshMenu.resolvedId);
        });
