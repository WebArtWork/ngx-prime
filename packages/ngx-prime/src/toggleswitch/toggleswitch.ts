...
import { ToggleSwitchChangeEvent, ToggleSwitchHandleTemplateContext, ToggleSwitchPassThrough } from '@wawjs/ngx-prime/types/toggleswitch';
...
export class ToggleSwitch extends BaseEditableHolder<ToggleSwitchPassThrough> {
    ...
    constructor() {
        ...
        if (isDevMode()) {
            ...
            console.warn('`<p-toggleswitch>` is deprecated and will be removed in a future major version. ' + 'Use a native `<input type="checkbox" pToggleSwitch>` instead.');
        }
    }
