...
import { MenubarItemTemplateContext, MenubarPassThrough } from '@wawjs/ngx-prime/types/menubar';
...
export class MenubarSub extends BaseComponent<MenubarPassThrough> {
    ...
    mobileActive = input<boolean, unknown>(undefined, { transform: booleanAttribute });

    autoDisplay = input<boolean, unknown>(undefined, { transform: booleanAttribute });
...
export class Menubar extends BaseComponent<MenubarPassThrough> {
     ...
     * @group Props
     */
    autoDisplay = input<boolean, unknown>(true, { transform: booleanAttribute });
    /**
     * Whether to hide a root submenu when mouse leaves.
     * @group Props
     */
    autoHide = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
