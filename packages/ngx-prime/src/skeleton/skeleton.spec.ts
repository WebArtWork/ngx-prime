...
describe('Skeleton', () => {
    ...
    describe('Container Style Calculation', () => {
        ...
        it('should calculate container style with size property', () => {
            (skeleton as any).size = () => '80px';
            (skeleton as any).borderRadius = () => '5px';
        ...
        it('should calculate container style with width and height', () => {
            (skeleton as any).size = () => undefined;
            (skeleton as any).width = () => '150px';
            (skeleton as any).height = () => '30px';
            (skeleton as any).borderRadius = () => '3px';
        ...
        it('should handle missing borderRadius', () => {
            (skeleton as any).borderRadius = () => undefined;
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle zero dimensions', () => {
            (skeleton as any).width = () => '0px';
            (skeleton as any).height = () => '0px';
        ...
        it('should handle very large dimensions', () => {
            (skeleton as any).width = () => '9999px';
            (skeleton as any).height = () => '9999px';
        ...
        it('should handle empty strings', () => {
            (skeleton as any).width = () => '';
            (skeleton as any).height = () => '';
        ...
        it('should handle invalid CSS values', () => {
            (skeleton as any).width = () => 'invalid-value';
            (skeleton as any).height = () => 'another-invalid';
        ...
        it('should handle rapid property updates', async () => {
            (skeleton as any).shape = () => 'rectangle';
            skeleton.cd.markForCheck();
            fixture.detectChanges();
            await new Promise((resolve) => setTimeout(resolve, 100));
            await fixture.whenStable();

            (skeleton as any).shape = () => 'circle';
            skeleton.cd.markForCheck();
            fixture.detectChanges();
            await new Promise((resolve) => setTimeout(resolve, 100));
            await fixture.whenStable();

            (skeleton as any).shape = () => 'square';
            skeleton.cd.markForCheck();
            fixture.detectChanges();
            await new Promise((resolve) => setTimeout(resolve, 100));
            await fixture.whenStable();
        ...
        it('should handle complex CSS calc expressions', () => {
            (skeleton as any).width = () => 'calc(100% - 20px)';
            (skeleton as any).height = () => 'calc(50vh - 10px)';
