...
describe('Carousel', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should have default values', () => {
            ...
            // Note: prior to the signals conversion, the `numScroll` *getter* had a bug and returned
            // `_numVisible` instead of `_numScroll`. Signal inputs can't replicate a buggy getter, so
            // `numScroll()` now correctly returns its own bound value (1) rather than numVisible's (3).
    ...
    describe('Public Methods', () => {
        ...
        it('should check if carousel is vertical', () => {
            ...
            (carouselInstance as any).orientation = () => 'vertical';
        ...
        it('should check if carousel is circular', () => {
            ...
            (carouselInstance as any).circular = () => true;
        ...
        it('should check if autoplay is enabled', () => {
            ...
            (carouselInstance as any).autoplayInterval = () => 1000;
        ...
        it('should check if carousel is empty', () => {
            ...
            (carouselInstance as any).value = () => [];
            expect(carouselInstance.isEmpty()).toBe(true);

            (carouselInstance as any).value = () => null;
            expect(carouselInstance.isEmpty()).toBe(true);
        });
    ...
    describe('Memory Management and Cleanup', () => {
        ...
        it('should handle destroy when no responsive options', () => {
            (carouselInstance as any).responsiveOptions = () => undefined;
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle page setter with invalid values', () => {
            ...
            (carouselInstance as any).page = () => 999;
