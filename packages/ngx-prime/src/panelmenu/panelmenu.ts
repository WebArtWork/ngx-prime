...
export class PanelMenuSub extends BaseComponent {
    ...
    transitionOptions = input<string>();

    parentExpanded = input<boolean, unknown>(undefined, { transform: booleanAttribute });
...
export class PanelMenuList extends BaseComponent {
    ...
    expanded = input<boolean, unknown>(undefined, { transform: booleanAttribute });
