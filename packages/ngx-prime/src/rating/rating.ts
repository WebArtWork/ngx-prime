...
import { StarFillIcon, StarIcon } from 'ngx-prime/icons';
import { Nullable } from 'ngx-prime/ts-helpers';
import { RatingIconTemplateContext, RatingPassThrough } from 'ngx-prime/types/rating';
import type { RatingRateEvent } from 'ngx-prime/types/rating';
import { RatingStyle } from './style/ratingstyle';
import { RatingDirective } from './nativerating';
...
export class Rating extends BaseEditableHolder<RatingPassThrough> {
     ...
     * @group Props
     */
    iconOnStyle = input<{ [klass: string]: any } | null>();
    /**
     ...
     * @group Props
     */
    iconOffStyle = input<{ [klass: string]: any } | null>();
    /**
