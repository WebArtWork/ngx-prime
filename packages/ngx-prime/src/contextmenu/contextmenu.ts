...
import { ContextMenuItemTemplateContext, ContextMenuPassThrough, ContextMenuSubmenuIconTemplateContext } from '@wawjs/ngx-prime/types/contextmenu';
...
export class ContextMenu extends BaseComponent<ContextMenuPassThrough> {
    ...
    private _target: HTMLElement | string | null | undefined;
    /**
     * Attaches the menu to document instead of a particular item.
     * @group Props
     */
    global = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
