...
import { MenuItem, SharedModule } from '@wawjs/ngx-prime/api';
...
describe('ContextMenu', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should initialize with generated id', () => {
            expect(contextMenuInstance.resolvedId).toBeTruthy();
            expect(typeof contextMenuInstance.resolvedId).toBe('string');
            expect(contextMenuInstance.resolvedId).toMatch(/^pn_id_/);
        });
    ...
    describe('Target and Global Context Menu Tests', () => {
        ...
        it('should bind trigger event listener on init', () => {
            ...
            (contextMenuInstance as any).target = () => mockTarget;
