...
import { booleanAttribute, ChangeDetectionStrategy, Component, ElementRef, EventEmitter, inject, Input, NgModule, numberAttribute, Output, ViewEncapsulation, viewChild } from '@angular/core';
