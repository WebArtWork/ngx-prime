...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="https://primefaces.org/cdn/ngx-prime/images/favicon.png">
    </head>
    <body>
        <${selector}></${selector}>
    </body>
...
import Aura from '@wawjs/css-prime-themes/aura';
  ...
  export const appConfig: ApplicationConfig = {
    ...
    const files = {
        'package.json': {
            content: {
                ...
                description: `ngx-prime ${componentName}`,
                license: 'MIT',
                keywords: [],
                scripts: {
                    ng: 'ng',
    ...
    return { files, title: `ngx-prime ${componentName}` };
};
