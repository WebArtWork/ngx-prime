    ...
    template: ` <div>
        <app-docsectiontext>
            ...
            <p>
                ...
                with <i>aria-hidden</i>, since the visible <i>value</i> text is always rendered alongside it. If the tags are dynamic,<i>aria-live</i> may be utilized as well. In case tags need to be tabbable, <i>tabIndex</i> can be added to
