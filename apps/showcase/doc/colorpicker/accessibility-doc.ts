    ...
    template: ` <div>
        <app-docsectiontext>
            ...
            <p>
                ...
                non-pointer alternative to dragging. Screen reader support is still an approximation since a real 2D slider has no dedicated ARIA pattern; prefer the native <i>&lt;input type="color"&gt;</i> element for new code. This component
                is deprecated and scheduled for removal in v23.
            </p>
        </app-docsectiontext>
