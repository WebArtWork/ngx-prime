...
@Component({
    selector: 'app-nextsteps-doc',
    standalone: true,
    imports: [AppDocSectionText, RouterModule],
    template: `
        <app-docsectiontext>
            <p>Welcome to the Prime UI Ecosystem! Once you have ngx-prime up and running, we recommend exploring the following resources to gain a deeper understanding of the library.</p>
