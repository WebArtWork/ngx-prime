...
@Component({
    ...
    template: ` <app-docsectiontext>
        ...
        <p>
            ...
            override it. Inside, an ordered list is used where the list item separators and the home icon have <i>aria-hidden</i> so they're ignored by screen readers. The last link, which represents the current route, gets
            <i>aria-current="page"</i>.
        </p>
