...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>ngx-prime provides 4 predefined themes out of the box; Aura, Material, Lara and Nora. See the <a routerLink="/theming">theming</a> documentation for details.</p>
        </app-docsectiontext>
