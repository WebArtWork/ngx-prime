    ...
    template: ` <div>
        <app-docsectiontext>
            ...
            <p>
                ...
                does not change related to state. The disabled and invalid states are exposed to assistive technology via <i>aria-disabled</i> and <i>aria-invalid</i>, since the component is rendered as a non-native element with <i>role="button"</i>.
            </p>
        </app-docsectiontext>
