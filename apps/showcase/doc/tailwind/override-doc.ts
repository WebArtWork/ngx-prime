...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <h5>Tailwind v4</h5>
            <p>Ensure <i>ngx-prime</i> layer is after <i>theme</i> and <i>base</i>, but before the other Tailwind layers such as <i>utilities</i>.</p>
            ...
            <h5>Tailwind v3</h5>
            <p>The <i>ngx-prime</i> layer should be between base and utilities.</p>
...
@import "tailwindcss-primeui";`
    ...
    theme: {
        ...
        options: {
            cssLayer: {
                name: 'ngx-prime',
                order: 'tailwind-base, ngx-prime, tailwind-utilities'
            }
        }
    }
})`
    ...
    code6 = {
        typescript: `@layer tailwind-base, ngx-prime, tailwind-utilities;
