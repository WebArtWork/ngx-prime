...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p class="mt-4">
                For a comprehensive starter guide, review the <a href="https://github.com/primefaces/ngx-prime-examples/tree/main/ngx-prime-quickstart-tailwind" target="_blank" rel="noopener noreferrer">ngx-prime-quickstart-tailwind</a> repository
