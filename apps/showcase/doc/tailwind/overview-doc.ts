...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                Tailwind is an outstanding CSS library, however it lacks a true comprehensive UI suite when combined with Angular, this is where ngx-prime comes in by providing a wide range of highly accessible and feature rich UI component library.
                The core of ngx-prime does not depend on Tailwind CSS.
            </p>
        </app-docsectiontext>
    `
})
