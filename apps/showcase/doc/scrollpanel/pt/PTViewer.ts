    ...
    template: `
        <app-docptviewer [docs]="docs">
            <p-scroll-panel [style]="{ width: '100%', height: '200px' }" [pt]="{ barY: '!visible !opacity-100' }">
                ...
                <p class="m-0">
                    Quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae
