...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                At PrimeTek, we have been developing UI component libraries since 2008. The web continues to undergo technological advancements, and as a result, we have to modernize and update our libraries to stay relevant. ngx-prime v18 is the
            ...
            <p>
                The most notable feature is the new <a routerLink="/theming">styled mode</a> implementation. Previous iterations use SASS at an external repo called <i>ngx-prime-sass-theme</i> which requires compilation of a <i>theme.css</i>a file.
