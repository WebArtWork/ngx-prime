...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <h4>Removed Files</h4>
            <li>Themes under the <i class="mark">ngx-prime/resources</i> path, migration to new styled mode is necessary.</li>
            ...
            <p><i class="mark">Message</i> interface in <i class="mark">ngx-prime/api</i> is renamed as <i class="mark">ToastMessageOptions</i> due to name collision with the <i>Message</i> component.</p>
            ...
            <h4>PrimeFlex CSS</h4>
            <p>In case you are using PrimeFlex CSS library, upgrade to PrimeFlex v4 since PrimeFlex v3 is not compatible with ngx-prime v18+</p>
        </app-docsectiontext>
    `
})
