...
@Component({
    selector: 'app-v21-migration-whatsnew-doc',
    standalone: true,
    imports: [AppDocSectionText, RouterModule],
    template: `
        <app-docsectiontext>
            <p>ngx-prime v21 represents a major advancement in PrimeTek's product vision. Key highlights of this release include:</p>
            ...
            <ul class="leading-normal px-10 list-disc">
                <li class="py-1">
                    The internal packages <i>@wawjs/css-prime-styles</i> and <i>@wawjs/css-prime-themes</i> should be version <i>2.0.2</i> or higher. These packages are updated automatically with a fresh install. If you encounter any issues with
                    visuals or animations, please verify that you are using the correct versions of these packages.
                </li>
            </ul>
        </app-docsectiontext>
    `
