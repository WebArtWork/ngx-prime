...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                Beginning with ngx-prime v20, PrimeTek adopted a no-breaking-change policy for incremental major version updates. ngx-prime v21 maintains this policy with one exception: due to the deprecation of Angular's animations package in Angular
