    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                ...
                source of truth. Prior to v20, ngx-prime has its own fork in default styles and for the design tokens <i>{{ '@' }}ngx-prime/themes</i> package is required. With v20, ngx-prime receives the styles from
