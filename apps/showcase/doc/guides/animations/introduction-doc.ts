...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                Various ngx-prime Components utilize native CSS animations to provide an enhanced user experience. The default animations are based on the best practices recommended by the usability experts. In case you need to customize the default
                animations, this documentation covers the entire set of built-in animations.
            </p>
            <p>
                Animations are defined using a combination of style classes and keyframes. The â <i>.&#123;classname&#125;-enter-active</i> and â <i>.&#123;classname&#125;-leave-active</i> classes specify the animation name, duration, and easing
