...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                PassThrough object can also be defined at a global level to apply all components in an application using the <i>provideNgxPrime</i> provider. For example, with the configuration here all panel headers have the <i>bg-primary</i> style
