...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                A UI component may also use other UI components, in this case section names are prefixed with <i>pc</i> (Prime Component) to denote the ngx-prime component begin used. This distinguishes components from standard DOM elements and
