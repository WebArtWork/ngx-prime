    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                Web Consortium). WCAG consists of recommendations for making the web content more accessible. ngx-prime's implementation target is <strong>WCAG 2.2 Level AA</strong>, combined with <strong>EN 301 549</strong> (the harmonised European
                ICT accessibility standard) and the <strong>WAI-ARIA Authoring Practices Guide</strong> for each component's interaction pattern. See the "Conformance" section of this guide for the current status and scope of this target.
            </p>
            <p>
