...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p class="doc-section-description mt-4">On the other hand, a fancy css based button using a div has no keyboard or screen reader support.</p>
