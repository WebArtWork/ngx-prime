...
@Component({
    ...
    template: ` <div>
        <app-docsectiontext>
            ...
            <p>The editable content area does not have an accessible name by default; use the <i>ariaLabel</i> or <i>ariaLabelledBy</i> properties to describe its purpose for screen reader users.</p>
        </app-docsectiontext>
    </div>`
})
