# MCP Server - ngx-prime

Model Context Protocol (MCP) server for ngx-prime component library. Provides AI assistants with comprehensive access to ngx-prime component documentation.
