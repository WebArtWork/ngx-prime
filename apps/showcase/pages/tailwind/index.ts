...
@Component({
    template: `<app-doc docTitle="Tailwind CSS - ngx-prime" header="Tailwind CSS" description="Integration between ngx-prime and Tailwind CSS." [docs]="docs" docType="page"></app-doc>`,
    standalone: true,
    imports: [AppDoc]
})
export class TailwindDemo {
    docs = [
        ...
        },
        {
            id: 'samples',
            label: 'Samples',
            description: 'Example uses cases with ngx-prime and Tailwind CSS.',
            children: [
                {
                    id: 'color-palette',
                    label: 'Color Palette',
