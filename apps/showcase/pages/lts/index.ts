        ...
        <div>
            ...
            <div class="card mb-8">
                ...
                <p class="m-0 leading-normal mb-8 text-secondary text-lg text-surface-800 dark:text-surface-50">
                    ...
                    <a [routerLink]="['/support']" class="text-primary font-medium hover:underline">ngx-prime PRO.</a>
                </p>
                    ...
                    <table class="doc-table">
                        ...
                        <tbody>
                            <tr class="text-lg text-surface-800 dark:text-surface-50">
                                ...
                                <td class="p-2"><a href="https://github.com/primefaces/ngx-prime/blob/master/CHANGELOG.md" target="_blank" rel="noopener noreferrer">Changelog</a></td>
                            </tr>
                            <tr class="text-lg text-surface-800 dark:text-surface-50">
                                <td class="p-2">
                                ...
                                <td class="p-2"><a href="https://github.com/primefaces/ngx-prime/blob/master/changelog-lts/v19-LTS.md" target="_blank" rel="noopener noreferrer">Changelog</a></td>
                            </tr>
                            <tr class="text-lg text-surface-800 dark:text-surface-50">
                                <td class="p-2">
                                ...
                                <td class="p-2">After v21 release</td>
                                <td class="p-2"><a href="https://github.com/primefaces/ngx-prime/blob/master/changelog-lts/v18-LTS.md" target="_blank" rel="noopener noreferrer">Changelog</a></td>
                            </tr>
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="flex-1">
                        ...
                        <p class="m-0 leading-normal mb-4 text-secondary text-lg text-surface-800 dark:text-surface-50">
                            ngx-prime comes with a commitment to provide long-term support, including regular security updates to keep your system protected against emerging threats.
                        </p>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="m-0 leading-normal mb-4 text-secondary text-lg text-surface-800 dark:text-surface-50">
                            We are dedicated to continuously improving ngx-prime to meet the evolving needs of our users. As part of our long-term support, we will provide regular updates and enhancements to add new features and functionality.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card m-0">
                ...
                <div class="flex flex-wrap text-lg -ml-8 -mt-8">
                    <div class="w-full lg:w-4/12 p-8">
                        <div class="text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Do I have to purchase a license for ngx-prime?</div>
                        ...
                        <div class="text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Is LTS License mandatory to use ngx-prime?</div>
                    ...
                    <div class="w-full lg:w-4/12 p-8">
                        ...
                        <p class="mt-0 p-0 leading-normal text-surface-800 dark:text-surface-50">No, ngx-prime PRO is the service where response of PrimeTek engineers is secured within 1 business day.</p>
                    </div>
                    <div class="w-full lg:w-4/12 p-8">
...
export class AppComponent implements OnInit {
    ...
    constructor() {
        this.titleService.setTitle('Long Term Support - ngx-prime');
