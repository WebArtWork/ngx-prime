...
@Component({
    template: `<app-doc docTitle="Unstyled Mode" header="Unstyled" description="Theming ngx-prime with alternative styling approaches." [docs]="docs" docType="page"></app-doc>`,
    imports: [AppDoc],
    standalone: true
})
