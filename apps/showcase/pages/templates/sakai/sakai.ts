...
export class SakaiPage {
    ...
    templateHeroData = {
        pattern: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/sakai-hero-pattern.png',
        ...
        dashboard1: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/sakai-hero-dashboard1.png',
        dashboard2: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/sakai-hero-dashboard2.png',
        description: 'Sakai is an application template for Angular and is distributed as a CLI project.',
        liveHref: 'https://sakai.ngx-prime.org/',
        docHref: 'https://sakai.ngx-prime.org/documentation',
        free: true,
    ...
    relatedData = [
        {
            src: 'https://primefaces.org/cdn/ngx-prime/images/layouts/diamond-ng.jpg',
            href: '/templates/diamond'
        },
        {
            src: 'https://primefaces.org/cdn/ngx-prime/images/layouts/babylon-ng.jpg',
            href: '/templates/babylon'
        },
        {
            src: 'https://primefaces.org/cdn/ngx-prime/images/layouts/ultima-ng.jpg',
    ...
    features1Data = [
        {
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/sakai-github.png',
        ...
        {
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/sakai-ready.png',
    ...
    features2Data = [
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/sakai-features2-responsive.png'
        },
        {
            title: 'Cross Browser Compatible',
            description: 'First class support for Firefox, Safari, Chrome and Edge.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/compatible-ng.png',
            darkSrc: 'https://primefaces.org/cdn/ngx-prime/images/compatible-ng-dark.png'
        },
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/apollo/apollo-features2-customizable.png',
            darkSrc: 'https://primefaces.org/cdn/ngx-prime/images/templates/apollo/apollo-features2-customizable-dark.png'
        },
        {
            title: 'Mobile Experience',
            description: 'Touch optimized enhanced mobile experience with responsive design.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/sakai-features2-mobile.png'
        }
    ];
    ...
    animationFeaturesData1 = [
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/babylon/features-animation-utilities.png'
        },
        {
            id: 2,
            title: 'PrimeBlocks',
            description: 'Fully compatible with PrimeBlocks, choose from the wide range of blocks and customize the way you like. Note that PrimeBlocks is not included in the template and requires a separate purchase.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/babylon/features-animation-blocks.png'
        },
        {
            id: 3,
            title: 'PrimeIcons',
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/babylon/features-animation-icons.png'
        }
    ];
    ...
    animationFeaturesData2 = [
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/features-animation-darkmode.png'
        },
        {
            id: 2,
            ...
            inlineFeaturesData: [
                {
                    id: 1,
                    title: 'Static',
                    src: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/Static.png'
                },
                {
                    id: 2,
                    title: 'Overlay',
                    src: 'https://primefaces.org/cdn/ngx-prime/images/templates/sakai/Overlay.png'
                }
            ]
        }
    ];
