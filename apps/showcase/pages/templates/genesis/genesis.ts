...
export class GenesisPage {
    ...
    templateHeroData = {
        pattern: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/hero-pattern.png',
        patternClass: 'select-none absolute z-[6] w-[58rem] md:w-[50rem] h-auto top-12 md:top-32 -left-24 md:-left-12 opacity-75',
        dashboard1: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/dashboard-2.png',
        dashboard2: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/dashboard-1.png',
        ...
        liveHref: 'https://genesis.ngx-prime.org',
        isMultipurpose: true,
    ...
    featuresData = [
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/horizontal-features-img-1.png'
        },
        {
            title: 'SEO & Performance',
            description: 'Can be further optimized with Angular SSR.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/horizontal-features-img-2.png'
        },
        {
            title: 'Animation / Effects',
            description: 'Enhance engagement with captivating animations and effects.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/horizontal-features-img-3.png'
        }
    ];
    ...
    features2Data = [
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/fully-responsive.png'
        },
        {
            title: 'Support',
        ...
        },
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/apollo/apollo-features2-quality.png',
            darkSrc: 'https://primefaces.org/cdn/ngx-prime/images/templates/apollo/apollo-features2-quality-dark.png'
        },
        {
        ...
        },
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/mobile-experience.png'
        }
    ];
    ...
    animationFeaturesData1 = [
        {
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/animation-landing-pages.png'
        },
        {
            id: 2,
            ...
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/animation-second-pages.png'
        },
        {
            id: 3,
            title: 'Dark & Light Modes',
            description: 'Easily switch between Light and Dark modes to match your aesthetic preferences.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/animation-dark-light-modes.png'
        },
        {
            id: 4,
            title: 'Themes',
            description: 'Customize with 16 color themes to align with your brand effortlessly.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/animation-menu-themes.png'
        }
    ];
    ...
    animationFeaturesData2 = [
        ...
        },
        {
            ...
            title: 'Figma File',
            description:
                'Genesis uses Figma as the design tool. It will be possible to download the Figma file after your purchase. You can <a href="https://www.figma.com/design/bGujrJyznnSatJFMtkXbTN/Preview-%7C-Genesis?node-id=0-1&t=etuXAwkUAEuhJ3p0-1" target="_blank" rel="noopener noreferrer">preview the Figma file</a> before the purchase. Note that ngx-prime UI components are excluded from the Genesis Figma file as they are available in PrimeOne for Figma only.',
            src: 'https://primefaces.org/cdn/ngx-prime/images/templates/genesis/animation-figma.png'
        }
    ];
