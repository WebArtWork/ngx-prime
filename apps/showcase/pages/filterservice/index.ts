...
@Component({
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc docTitle="FilterService - ngx-prime" header="FilterService" description="FilterService is a helper utility to filter collections against constraints." [docs]="docs"></app-doc>`
})
