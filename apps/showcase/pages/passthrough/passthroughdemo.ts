...
@Component({
    ...
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc docTitle="ngx-prime - Pass Through" header="Pass Through" description="The Pass Through attributes is an API to customize the internal DOM Structure of the components." [docs]="docs" docType="page"></app-doc> `
})
