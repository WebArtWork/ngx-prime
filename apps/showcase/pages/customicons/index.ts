...
@Component({
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc title="Custom Icons - ngx-prime" header="Custom Icons" description="ngx-prime components can be used with any icon library using the templating features." [docs]="docs" docType="page"></app-doc>`
})
