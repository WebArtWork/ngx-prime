...
@Component({
    template: `<app-doc
        docTitle="Overlay API - ngx-prime"
        header="Overlay API"
        description="This API allows overlay components to be controlled from the ngx-prime. In this way, all overlay components in the application can have the same behavior."
        [docs]="docs"
