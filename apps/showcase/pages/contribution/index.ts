...
@Component({
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc docTitle="Contribution - ngx-prime" header="Contribution Guide" description="Welcome to the ngx-prime Contribution Guide and thank you for considering contributing." [docs]="docs"></app-doc> `
})
